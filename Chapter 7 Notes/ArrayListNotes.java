...
public class ArrayListNotes
{
    ...
    public static ArrayList<Integer> createRandomIntegerList(int size, int range)
    {
         ...
         *      Instead we use the wrapper class(i.e. Integer, Double)
         */
        ...
        for (int i = 0; i < size; i++)
        {
             ...
             * Autoboxing
             * 
             * Primitives are automatically converted to their corresponding wrapper classes,
             *      Type promotion does not occur
             */

            list.add( value ); //appends a value to the array
        }
        return list;
    }
